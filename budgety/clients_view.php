...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`clients`.`total_income`" => "total_income",
		"`clients`.`total_expense`" => "total_expense",
		"`clients`.`available_budget`" => "available_budget"
	);
	// mapping incoming sort by requests to actual query fields
	$x->SortFields = array(   
		1 => '`clients`.`client_id`',
		2 => 2,
		3 => '`clients`.`total_income`',
		4 => '`clients`.`total_expense`',
		5 => '`clients`.`available_budget`'
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`clients`.`client`" => "Client",
		"`clients`.`total_income`" => "Total income",
		"`clients`.`total_expense`" => "Total expense",
		"`clients`.`available_budget`" => "Available budget"
	);
	...
	$x->ColCaption = array("Client", "Total income", "Total expense", "Available budget");
	$x->ColFieldName = array('client', 'total_income', 'total_expense', 'available_budget');

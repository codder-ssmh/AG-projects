<?php
	...
	*/
	...
	$schema = array(   
		'clients' => array(   
			'client_id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'client' => array('appgini' => 'VARCHAR(255) null '),
			'total_income' => array('appgini' => 'DECIMAL(10,0) null default \'0\' '),
			'total_expense' => array('appgini' => 'DECIMAL(10,0) null default \'0\' '),
			'available_budget' => array('appgini' => 'DECIMAL(10,0) null default \'0\' ')
		),
		'incomes' => array(   
			'income_id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'date' => array('appgini' => 'DATE null '),
			'client' => array('appgini' => 'INT unsigned null '),
			'amount' => array('appgini' => 'DECIMAL(10,0) null default \'0\' ')
		),
		'expenses' => array(   
			'expense_id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'date' => array('appgini' => 'DATE null '),
			'client' => array('appgini' => 'INT unsigned null '),
			'amount' => array('appgini' => 'DECIMAL(10,0) null default \'0\' ')
		)

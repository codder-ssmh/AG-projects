<?php
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['client'], $data['total_income'], $data['total_expense'], $data['available_budget']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['client_id'], $data['client'], $data['total_income'], $data['total_expense'], $data['available_budget']
